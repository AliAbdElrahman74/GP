...
class Database:
    def __init__(self):
        self.db1 = MySQLdb.connect(host='localhost',
                     user='root',
                     passwd='20130133',
                     db='gpcharactersmodwwanaV2',
                     charset='UTF8',
                     use_unicode=True)
        self.db2 = MySQLdb.connect(host='localhost',
                     user='root',
                     passwd='20130133',
                     db='gpcharactersfrequency_window1x1_samir(V2)',
                     charset='UTF8',
                     use_unicode=True)
...
#    word = unicode(word, "utf-8")
    ...
    try:
       ...
       return results[0][0]
        ...
        print word
        print ("Error: unable to fecth data primary in char")
...
#    word = unicode(word, "utf-8")
    ...
    try:
       ...
       return results
        ...
        print word
        print ("Error: unable to fecth data in secondary in char")
...
#            print "IIIIIIIIIIIIIIIIIIIIIIIIIIII"
        ...
        print word1, word2
        print ("Error: unable to feucth data freq in char")
        ...
        for j in range (len(window)): ## loop for summation
            ...
            for counter in allWords:
                if (counter[0] == removeTashkeel(counter[0])):
                    continue
                tempSumAll += fun(counter[0],window[j])
            sumAll.append(tempSumAll);
        ...
        for k in range (len(allWords)):
            ...
            for j in range (len(window)): ## loop for summation
                ...
                if word_tekrar == 0:
                    ...
                    sum_prob = math.log10((word_tekrar* 1.0) /sumAll[j])
                sumAllProb += sum_prob

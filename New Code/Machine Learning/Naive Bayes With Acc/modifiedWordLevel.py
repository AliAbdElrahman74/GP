...
arr = []
inputFiles = ['input3.docx', 'input2.docx', 'input1.docx']
...
#         print word[0]
    ...
    if not allWords:
        ...
        result += modifiedCharLevel.generatee(arr[i])
        result +=" "
        continue
    counter = 0
...
output = []
testingFiles = ['testing3.docx', 'testing2.docx', 'testing1.docx']
